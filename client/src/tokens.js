...
export const colors = {
  ...
  // 3단계에서 대비 재조정. 흰 배경 기준 데이터 3계열을 전부 3:1 이상으로 올렸다.
  // 이전 값은 chart-2 1.80:1, chart-3 1.22:1 로 선이 보이지 않았다(WCAG 2.2 1.4.11 미달)
  chart: {
    1: '#2563EB',   // 5.17:1  주 계열. primary 와 같은 값
    2: '#3B82F6',   // 3.68:1  보조 계열
    3: '#7C838C',   // 3.83:1  3계열. 파랑이 아닌 중립색이라 색상으로도 구분된다
